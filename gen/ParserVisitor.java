...
public interface ParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link Parser#htmlDocument}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitHtmlDocument(Parser.HtmlDocumentContext ctx);
	/**
	 * Visit a parse tree produced by {@link Parser#scriptletOrSeaWs}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitScriptletOrSeaWs(Parser.ScriptletOrSeaWsContext ctx);
	/**
	 * Visit a parse tree produced by {@link Parser#htmlElements}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitHtmlElements(Parser.HtmlElementsContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link Parser#htmlChardata}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitHtmlChardata(Parser.HtmlChardataContext ctx);
	/**
	 * Visit a parse tree produced by {@link Parser#htmlMisc}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitHtmlMisc(Parser.HtmlMiscContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link Parser#script}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitScript(Parser.ScriptContext ctx);
	/**
